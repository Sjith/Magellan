        ...
        if (other instanceof Pair) 
        {
                ...
                return 
                  (( this.m_first == otherPair.m_first || 
                   ( this.m_first != null && otherPair.m_first != null && this.m_first.equals(otherPair.m_first) )) 
                && ( this.m_second == otherPair.m_second ||
                   ( this.m_second != null && otherPair.m_second != null && this.m_second.equals(otherPair.m_second) )) 
                   );
        }
